...
export const isCreateQuoteCustomer = (payload: CreateQuote): payload is CreateQuoteCustomer => (!payload.vendorName);

export const isCreateQuoteVendor = (payload: CreateQuote): payload is CreateQuoteVendor => (!!payload.vendorName);
